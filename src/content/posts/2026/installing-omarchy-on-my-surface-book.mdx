...
- [Omarchy core package list](https://github.com/basecamp/omarchy/blob/quattro/install/omarchy-base.packages)
...
- [Supported Devices and Features, linux-surface](https://github.com/linux-surface/linux-surface/wiki/Supported-Devices-and-Features)
