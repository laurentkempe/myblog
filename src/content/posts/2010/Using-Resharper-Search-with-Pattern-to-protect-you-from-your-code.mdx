...
> public static TSource **FirstOrDefault**&lt;TSource&gt;(this [NotNull] IEnumerable&lt;TSource&gt; source) *in class Enumerable*
> 
> ### Summary:
> 
...
> 
> source:
> The IEnumerable&lt;TSource&gt; to return the first element of.
> 
> ### Type Parameters:
> 
> TSource:
...
Yeah, **FirstOrDefault** might return null, so if you chain a call to another method it just crashes!
