...
> 3. Enter your credentials. By default, you will connect to Master database. If you want to connect to a specific database, click options and enter the database name. Please be aware that USE &lt;database&gt; is not supported.
...
> 
> Here is the information you need to enter into Microsoft SQL Server Management Studio. You will get this from: 
> 
