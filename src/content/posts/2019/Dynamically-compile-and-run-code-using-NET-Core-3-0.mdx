...
<Image src="https://raw.githubusercontent.com/laurentkempe/DynamicRun/master/doc/screenshot.png" width="100%" height="100%" alt="Running" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />
