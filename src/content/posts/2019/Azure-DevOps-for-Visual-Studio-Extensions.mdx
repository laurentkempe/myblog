...
<YouTube id="NuYDAs3kNV8" class="yt-width" />
<br/>
...
<Image src="https://farm8.staticflickr.com/7807/32349146347_f88d9b1fce_o.png" alt="Azure DevOps Release pipeline" width="100%" height="100%" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />

In the details
<Image src="https://farm8.staticflickr.com/7840/47290958411_251b163117_o.png" alt="Azure DevOps Release pipeline tasks" width="100%" height="100%" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />

The first task publishes Git Diff Margin to Visual Studio Extension using [Azure DevOps Extension Tasks](https://marketplace.visualstudio.com/items?itemName=ms-devlabs.vsts-developer-tools-build-tasks)
...
<Image src="https://farm8.staticflickr.com/7820/46376429945_e3fde68d19_o.png" alt="Azure DevOps Releasing" width="100%" height="100%" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />

And if everything worked correctly you see the following result
<Image src="https://farm8.staticflickr.com/7883/40326503893_58116c2328_o.png" alt="Azure DevOps Release result" width="100%" height="100%" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />
