...
<Image src="https://c6.staticflickr.com/8/7494/27687906621_782bf08e81_o.jpg" alt="Reverse proxy & Kestrel containers architecture" title="Reverse proxy & Kestrel containers architecture" width="100%" height="100%" class="container mx-auto px-4 py-4 flex flex-col sm:flex-row max-w-[640px]" />
...
{/* Temporarily commented out due to YouTube API issue - this is a pre-existing issue unrelated to Astro upgrade
<YouTube id="QvAz9mVx5TI" class="yt-width" />
*/}
<br/>
