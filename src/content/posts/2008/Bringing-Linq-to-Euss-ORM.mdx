...
Four days ago I went to [Sébastien Ros](http://www.dotnetguru2.org/sebastienros/), the architect of Euss, with a first draft implementation of IQueryable&LT;T&GT; for Euss. Almost everything was already implemented but it was missing the IQueryable&LT;T&GT;. Today Sébastien came back to me with a first implementation that I could quickly integrate.
