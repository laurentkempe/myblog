...
To use the MCP server, we can use for example Claude, Visual Studio Code or any other client supporting MCP with SSE. 

You can configure Visual Studio Code, adding the following configuration to your `settings.json` file:
...
Claude Desktop is currently not supporting SSE but you can you a proxy with the following addition to the `claude_desktop_config.json` file:
...
You can read more about how to configure and use both Claude and Visual Studio Code on my previous post [Dockerizing your .NET C# MCP Server for AI Clients like Claude Desktop](https://laurentkempe.com/2025/03/27/dockerizing-your-dotnet-csharp-mcp-server-for-ai-clients-like-claude-desktop/).
