...
This time, we are using Phi-4-mini-instruct, a smaller model from Microsoft, available in Azure OpenAI.
...
Get the source code on GitHub [laurentkempe/daprPlayground/Conversation](https://github.com/laurentkempe/daprPlayground/tree/master/Conversation#readme).
