...
<Alert mode="info">
Server-side SSE transport protocol is not supported at the time of writing but it is in development. The client-side SSE transport protocol is supported and can be used to call MCP servers.
</Alert>
