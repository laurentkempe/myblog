...
<article class="prose prose-lg max-w-none dark:prose-invert
  ...
  I founded and managed two startups with my brother Mathieu and some friends: Jobping and WorkPlaces.

  Microsoft awarded me from April 2002 to April 2012: [Most Valuable Professional (MVP)](https://mvp.microsoft.com/en-us/PublicProfile/7749?fullName=Laurent%20%20Kemp%C3%A9).
  And since August 2021, I got awarded again 😎!
    JetBrains recognized me as a [JetBrains Community Contributor](https://www.jetbrains.com/lp/jetbrains-community-contributor/) for a couple of years.

  <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-28 mt-2">
    <a href="https://mvp.microsoft.com/en-us/PublicProfile/7749?fullName=Laurent%20%20Kemp%C3%A9" target="_blank" rel="noopener noreferrer">
      <Image src="/images/awards/Microsoft MVP.png" 
          alt="Microsoft MVP"
          width="181"
          height="74"
      />
    </a>
    <a href="https://www.jetbrains.com/lp/jetbrains-community-contributor/" target="_blank" rel="noopener noreferrer">
      <Image src="/images/awards/JetBrains Community Contributor.png" 
          alt="JetBrains Community Contributor"
          width="151"
          height="151"
      />
    </a>
