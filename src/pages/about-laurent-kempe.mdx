...
<article class="prose prose-lg max-w-none dark:prose-invert
  ...
  JetBrains recognized me as a [JetBrains Community Contributor](https://www.jetbrains.com/lp/jetbrains-community-contributor/) for many years.

  I finally founded and managed two startups with my brother Mathieu and some friends: Jobping and WorkPlaces.

  <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-28 mt-8">
